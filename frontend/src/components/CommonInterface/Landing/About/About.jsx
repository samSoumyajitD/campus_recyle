    ...
    <div className="about">
      ...
      <div className="about_content">
        <li>
          ...
          products, promoting a culture of reusing.
        </li>
        <li>
          {" "}
          Sellers can list their items with a few simple clicks, and buyers can
          browse through the products easily. We prioritize safety and trust,
          ensuring a secure environment for our users.
        </li>
        <li>
          {" "}
          We don’t handle payments directly yet. For the time being, parties can
          arrange payment and delivery outside the platform after negotiation.
        </li>
        <li>
          {" "}
