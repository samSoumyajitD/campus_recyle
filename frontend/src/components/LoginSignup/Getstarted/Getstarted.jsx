  ...
  return (
    <div className="getstarted-page">
      ...
      <div className="landing-navbar-left-logo">
        ...
        <div className='getstarted-page-headtext'>How do you want to use Campus Recycle?</div>
        <div className='getstarted-page-subheadtext'>We’ll personalize your setup experience accordingly.</div>
       < div className="getstarted-button">
        ...
        >
            ...
            <div className='sidebar-button-icon'><FaRecycle /></div>
            <div className='sidebar-button-text'>
            <p className='sidebar-button-subtext'> I’m here to hire tech talent</p>
        ...
        >
            ...
            <div className='sidebar-button-icon'><FaShopify  /></div>
            <div className='sidebar-button-text'>
            <p className='sidebar-button-subtext'> I’m here to practice and prepare</p>
